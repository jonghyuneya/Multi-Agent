...
from closing_briefing.models import ClosingBriefingState, BriefingConfig, Reference, StructuredSource
...
# New source tools adapter (uses same tools as validation_agent)
try:
    ...
    BriefingSourceToolAdapter = None
    SourceConfig = None
    create_briefing_tools = None
