...
async def question_clarity_checker(user_question: str) -> str:
    ...
    try:
        prompt = f"""
        You are a helpful assistant that evaluates if user questions are clear and specific enough.
        
        For the given question, determine:
        1. Is the question clear and specific enough to understand what the user wants?
        2. If unclear, what clarification would help?
